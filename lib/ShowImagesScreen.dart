...
final List<AssetImage> images = [
  const AssetImage('assets/images/caballo.jpg'),
  const AssetImage('assets/images/cabra.jpg'),
  const AssetImage('assets/images/cerdo.jpg'),
  const AssetImage('assets/images/gato.jpg'),
  const AssetImage('assets/images/leon.jpg'),
  const AssetImage('assets/images/lobo.jpg'),
  const AssetImage('assets/images/perro.jpg'),
  const AssetImage('assets/images/pulpo.jpg'),
  const AssetImage('assets/images/sepia.jpg'),
  const AssetImage('assets/images/tiburon.jpg'),
  const AssetImage('assets/images/tortuga.jpg'),
