...
class ScoreRecordTableViewState extends State<ScoreRecordTableView> {
  ...
  void sortTable(int columnIndex, bool ascending) {
    if (columnIndex == 0) {
      ...
      games.sort((a, b) => ascending ? a.datePlayed!.compareTo(b.datePlayed!) : b.guesses!.compareTo(a.guesses!));
          ...
          children: [
            TableRow(
              children: [
                ...
                Center(
                  child: InkWell(
                    onTap: () => sortTable(3, !sortAscending),
                    child: const Text('Tiempo jugado', style: TextStyle(fontWeight: FontWeight.bold)),
                  ),
                ),
                Center(
                  child: InkWell(
                    onTap: () => sortTable(4, !sortAscending),
                    child: const Text('Fecha jugada', style: TextStyle(fontWeight: FontWeight.bold)),
                  ),
                ),
              ],
            ),
            ...
            for (var game in games)
              TableRow(
                children: [
                  ...
                  Center(child: Text(game.timePlayed!)),
                  Center(child: Text(game.datePlayed!)),
                ],
              ),
          ],
        ),
